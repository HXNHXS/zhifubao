...
- (void)viewDidLoad {
    ...
    [button addTarget:self action:@selector(weChatPay:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)weChatPay:(UIButton *) button
{
    if (![WXApi isWXAppInstalled]) {
        UIAlertView * alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:@"还没有安装微信，快去安装吧" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil];
        [alertView show];
    }
    else
        [self sendPay_demo];
